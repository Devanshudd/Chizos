        ...
        <div className='relative bottom-0 bg-[#263134] mt-[5rem] flex flex-col h-[400px] items-center mobile:h-fit z-20'>
            ...
            <section className='absolute laptop:top-[-3.5rem] bg-[#fcf5ee] laptop:w-[70vw] laptop:py-[1.5rem] 
             ...
             w-[80vw] smallM:px-[1rem] smallM:w-[90vw]'>
                ...
                <NavLink to='/contact' className='bg-red-600 text-white py-[0.5rem] px-[0.8rem] my-auto rounded-md
            ...
            mobile:flex-col mobile:justify-start mobile:gap-[2.5rem] mobile:mb-[4rem]'>
             <div className='w-[30%] mobile:w-[80%] mobile:mt-[4rem]'>
                ...
                mobile:text-justify'>
                Welcome to Chizos, your go-to destination for delicious meals delivered straight to your doorstep. 
                At Chizos, we're passionate about connecting you with your favorite cuisines.
                </p>
             </div>
             <div className='flex flex-col gap-[2rem] text-center items-center'>
               ...
               <div className='flex gap-[1.2rem]  items-center'>
                 ...
                 <Link to='https://www.linkedin.com/in/devanshudd/ ' className='bg-gray-900 p-2 rounded-[50%]'>
                    <FaLinkedin className='text-2xl text-white'/>
                 </Link>
                 <Link to='https://twitter.com/dudhia_d' className='bg-gray-900 p-2 rounded-[50%]'>
                    <FaXTwitter className='text-xl text-white'/>
                 </Link>
                 <Link to='https://github.com/Devanshudd ' className='bg-gray-900 p-2 rounded-[50%]'>
