...
const Main = () => {
  ...
  <input 
    ...
    value={searchText} 
    className="border pl-4 pr-10 py-1 rounded border-[#070502] outline-red-600 w-[25vw]" 
    onChange={(e) => {
      setSearchText(e.target.value)
      searchData(e.target.value)
    }}
  />
  <span className="absolute right-3 top-1/2 transform -translate-y-1/2" role="img" aria-label="Search">🔎</span>
</div>
